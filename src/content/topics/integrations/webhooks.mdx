...
The webhook payload format is identical to the entry format for the [audit log](/home/managing-flags/audit-log-history). See our [REST API Documentation](https://apidocs.launchdarkly.com/reference#webhooks-overview) for an example payload.
